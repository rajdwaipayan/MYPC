...
namespace MyWindowsFormsApp.Repository
{
    public class ItemRepository
    {
        public bool Add(Item item)
        {
            ...
            {
                //Connection
                string connectionString = @"Server=PC-301-06\SQLEXPRESS; Database=CoffeeShop; Integrated Security=True";
        ...
        public DataTable Search(string name)
        {
            ...
            {
                //Connection
                string connectionString = @"Server=Server=PC-301-06\SQLEXPRESS; Database=CoffeeShop; Integrated Security=True";
                SqlConnection sqlConnection = new SqlConnection(connectionString);
